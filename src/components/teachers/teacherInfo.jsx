...
import { TeacherProfilePageContainer, TeacherProfileTabList, TeacherProfileTabListBtn } from './style';
...
function TeacherInfo() {
    const { id } = useParams()
    const resultData = teacherData.maindata.find((value) => value.id === parseInt(id));
